...
- 🔭 Backend engineer with **5+ years of experience**, focused on **Go-based distributed systems**
- ⚙️ I build scalable **REST & gRPC APIs**, event-driven microservices, and high-performance backends
...
- **Primary Language:**
  ...
  [<img alt="Go" src="https://img.shields.io/badge/Go-%2300ADD8.svg?style=flat-circle&logo=go&logoColor=white" title="Go"/>](https://go.dev/)

- **API & Frameworks:**

  [<img alt="Gin" src="https://img.shields.io/badge/Gin-%2300ADD8?style=flat-circle&logo=go&logoColor=white" title="Gin"/>](https://gin-gonic.com/)
  [<img alt="gRPC" src="https://img.shields.io/badge/gRPC-%23244c5a?style=flat-circle&logo=google&logoColor=white" title="gRPC"/>](https://grpc.io/)
  [<img alt="REST" src="https://img.shields.io/badge/REST_API-grey?style=flat-circle" title="REST"/>]()
...
- **Databases:**
  ...
  [<img alt="PostgreSQL" src="https://img.shields.io/badge/PostgreSQL-%23316192.svg?style=flat-circle&logo=postgresql&logoColor=white" title="PostgreSQL"/>](https://www.postgresql.org/)
  [<img alt="MongoDB" src="https://img.shields.io/badge/MongoDB-001e2b?style=flat-circle&logo=mongodb&logoColor=%2311aa50" title="MongoDB"/>](https://www.mongodb.com/)
  [<img alt="Redis" src="https://img.shields.io/badge/Redis-%23DD0031.svg?style=flat-circle&logo=redis&logoColor=white" title="Redis"/>](https://redis.io/)

- **Messaging & Event-Driven:**

  [<img alt="RabbitMQ" src="https://img.shields.io/badge/RabbitMQ-FF6600?style=flat-circle&logo=rabbitmq&logoColor=white" title="RabbitMQ"/>](https://www.rabbitmq.com/)
  [<img alt="Kafka" src="https://img.shields.io/badge/Kafka-231F20?style=flat-circle&logo=apachekafka&logoColor=white" title="Kafka"/>](https://kafka.apache.org/)

- **DevOps & Infrastructure:**

  [<img alt="Docker" src="https://img.shields.io/badge/Docker-%230db7ed.svg?style=flat-circle&logo=docker&logoColor=white" title="Docker"/>](https://www.docker.com/)
  [<img alt="Kubernetes" src="https://img.shields.io/badge/Kubernetes-%23326ce5.svg?style=flat-circle&logo=kubernetes&logoColor=white" title="Kubernetes"/>](https://kubernetes.io/)
  [<img alt="Nginx" src="https://img.shields.io/badge/Nginx-%23009639.svg?style=flat-circle&logo=nginx&logoColor=white" title="Nginx"/>](https://nginx.org/)
  [<img alt="Linux" src="https://img.shields.io/badge/Linux-%23FCC624.svg?style=flat-circle&logo=linux&logoColor=black" title="Linux"/>](https://www.linux.org/)

- **Monitoring & Observability:**

  [<img alt="Prometheus" src="https://img.shields.io/badge/Prometheus-E6522C?style=flat-circle&logo=prometheus&logoColor=white" title="Prometheus"/>](https://prometheus.io/)
  [<img alt="Grafana" src="https://img.shields.io/badge/Grafana-F46800?style=flat-circle&logo=grafana&logoColor=white" title="Grafana"/>](https://grafana.com/)
  [<img alt="Sentry" src="https://img.shields.io/badge/Sentry-362D59?style=flat-circle&logo=sentry&logoColor=white" title="Sentry"/>](https://sentry.io/)
...
- **Frontend:**
 ...
 [<img alt="CSS3" src="https://img.shields.io/badge/css3-%231572B6.svg?style=flat-circle&logo=css3&logoColor=white" title="CSS3"/>](https://developer.mozilla.org/en-US/docs/Web/CSS)
  [<img alt="JavaScript" src="https://img.shields.io/badge/javascript-%23323330.svg?style=flat-circle&logo=javascript&logoColor=%23F7DF1E" title="JavaScript"/>](https://developer.mozilla.org/en-US/docs/Web/JavaScript)
   ...
   [<img alt="Redux" src="https://img.shields.io/badge/Redux-%23593d88.svg?style=flat-circle&logo=redux&logoColor=white" title="Redux"/>](https://redux.js.org/)
   [<img alt="Node.js" src="https://img.shields.io/badge/Node.js-339933?style=flat-circle&logo=node.js&logoColor=white" title="Node.js"/>](https://nodejs.org/)

- **Testing:**

  [<img alt="Testify" src="https://img.shields.io/badge/Testify-%2300ADD8?style=flat-circle&logo=go&logoColor=white" title="Testify"/>](https://github.com/stretchr/testify)
  [<img alt="Mockery" src="https://img.shields.io/badge/Mockery-grey?style=flat-circle" title="Mockery"/>](https://github.com/vektra/mockery)
